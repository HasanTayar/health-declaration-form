...
import { Q4Schema } from "@/lib/schema/formSchema";
...
const Q4 = () => {
  ...
  const form = useForm<z.infer<typeof Q4Schema>>({
    resolver: zodResolver(Q4Schema),
  });

  const saveData = (data: z.infer<typeof Q4Schema>) => {
    setState({ ...state, ...data });
    navigate("/health-declaration-form/yes-no-form/q-5");
  };
